...
abstract class SimpleListAdapter<ITEM> constructor(private var mDataList: List<ITEM>? = null) :
    RecyclerView.Adapter<SimpleListAdapter.SimpleViewHolder<ITEM>>() {
    ...
    abstract class SimpleViewHolder<ITEM> : AbsItemViewHolder<ITEM>, OnItemEventListener<ITEM> {
        ...
        override fun onItemLongClick(position: Int, data: ITEM) {

        }

        override fun onItemChildClick(v: View, position: Int, data: ITEM) {
