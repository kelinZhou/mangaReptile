...
abstract class ItemListFragmentPresenter<V : ItemListDelegate<VC, I>, VC : ItemListDelegate.ItemListDelegateCallback<I>, ID, I : Cell, W> :
    ...
    final override fun onListItemClick(position: Int, item: I) {
    ...
    final override fun onListItemLongClick(position: Int, item: I) {
    ...
    final override fun onListItemChildClick(position: Int, v: View, item: I) {
    ...
    open inner class ItemListDelegateCallbackImpl : CommonListDelegateCallbackImpl(),
        ItemListDelegate.ItemListDelegateCallback<I>
}
