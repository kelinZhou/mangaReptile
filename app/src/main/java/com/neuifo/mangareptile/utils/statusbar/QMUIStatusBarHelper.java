package com.neuifo.mangareptile.utils.statusbar;
...
//            Integer transparentValue = getStatusBarAPITransparentValue(context);
...
//            }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (QMUIDeviceHelper.isTablet(context)
                && sStatusbarHeight > MeasureUtil.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
            //状态栏高度大于25dp的平板，状态栏通常在下方
            sStatusbarHeight = 0;
        } else {
            if (sStatusbarHeight <= 0
                    || sStatusbarHeight > MeasureUtil.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP * 2)) {
