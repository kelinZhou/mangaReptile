package com.neuifo.widgetlibs.statelayout
 ...
 * **创建人:** kelin
 *
 * **创建时间:** 2019-07-23  15:42
 *
 * **版本:** v 1.0.0
 */
class StatePageLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ConstraintLayout(context, attrs, defStyleAttr),
    StatePage {
    /**
     * 数据展示页面。
     */
